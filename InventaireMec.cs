...
{
    internal class InventaireMec : Form
    {
        #region Windows Form Designer generated code 
        [DebuggerNonUserCode()]
        public InventaireMec() : base()
        {
            InitializeComponent();
        }
        [DebuggerNonUserCode()]
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "InventaireMec";
            this.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "ControleurServeur.InventaireMec";
            this.Load += new System.EventHandler(this.InventaireMec_Load);
        ...
        private void lvwHistorique_KeyDown(object sender, KeyEventArgs e) => throw new NotImplementedException();
        #endregion
        ...
        private void RemplirListViewHistorique()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(sWhere)) { rstHist.Open("SELECT * FROM InventaireMecModif WHERE " + sWhere + " ORDER BY numid DESC", odbc, CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic); }
                else { rstHist.Open("SELECT * FROM InventaireMecModif ORDER BY numid DESC", odbc, CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic); }
            ...
            {
                AfficherErreur("InventaireMec", "RemplirListViewHistorique", ex);
            }
        }
        ...
        private void cmdAfficherHistorique_Click(object eventSender, EventArgs eventArgs)
        {
            ...
            {
                AfficherErreur("InventaireMec", "cmdAfficherHistorique_Click", ex);
            }
        }
        private void InventaireMec_Load(object eventSender, EventArgs eventArgs)
        {
            try
            {
            ...
            {
                AfficherErreur("InventaireMec", "Form_Load", ex);
            }
        }
        private void lvwHistorique_ColumnClick(object eventSender, ColumnClickEventArgs eventArgs)
        {
            ...
            {
                AfficherErreur("InventaireMec", "lvwHistorique_ColumnClick", ex);
            }
        }
        private void ModifierInventaire(string sPiece, string sQuantite)
        {
            try
            {
                ...
                rstInv.Open("SELECT * FROM InventaireMec WHERE NoItem = '" + Strings.Replace(sPiece, "'", "''") + "'", odbc, CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic);
            ...
            {
                AfficherErreur("InventaireMec", "ModifierInventaire", ex);
            }
        }
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                AfficherErreur("InventaireMec", "cmdFermer_Click", ex);
            }
        }
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            foreach (ListViewItem p in lvwHistorique.Items)
            {
                ...
                rstInv.Open($"select * from InventaireMec where NoItem='{p.SubItems[3].Text}'", odbc, CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic);
                r++;
                oXLSheet.Cells[r, 1] = p.SubItems[0].Text;
                oXLSheet.Cells[r, 2] = p.SubItems[1].Text;
                oXLSheet.Cells[r, 3] = p.SubItems[2].Text;
        ...
        private void linkLabel5_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            for (int a = 0; a < nbpages; a++)
            {
                ...
                lvi.lblTitre.Text = lblTitre.Text + " ";
                for (int b = 0; b < colones.Length; b++){lvi.listView1.Columns.Add(colones[b]);}
                lvi.lblNoPage.Text = $"Page {a + 1}/{nbpages}";
                ...
                {
                    if (rstInv.State == 1) rstInv.Close();
                    rstInv.Open($"select * from InventaireMec where NoItem='{lvwHistorique.Items[x].SubItems[3].Text}'", odbc, CursorTypeEnum.adOpenDynamic, LockTypeEnum.adLockOptimistic);
                    double total = 0d;
                    ListViewItem lv = lvi.listView1.Items.Add(string.Empty);
                    lv.SubItems[0].Text = lvwHistorique.Items[x].SubItems[0].Text;
                    lv.SubItems.Insert(1, new ListViewItem.ListViewSubItem(null, lvwHistorique.Items[x].SubItems[1].Text));
